...
# Brand
Clearly the two numeric predictor factors are not contributing so much into the response variable. So, let us try to investigate the text predictors and begin with the _brand_ predictor.
