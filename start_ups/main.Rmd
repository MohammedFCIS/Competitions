...
```
 The plot shows that there is a CLEAR positive correlation between the two predictors, and also having the same distribution; therefore we need to deal with NA carefully to make it
normally distributed,and at the ned we will be using ONLY one feature ofthese.
...
around 17% of the feature's values are missing
